...
export default function ProductManagement() {
  ...
  return (
    <>
      <Container>
        <h1 style={{marginTop:"20px",fontWeight:"bold" ,textAlign:"center"}}>Product Management</h1>
        <Button variant="outline-dark" style={{marginTop:"20px",marginBottom: "20px", fontWeight:"bold" ,textAlign:"center"}} onClick={handleShowAdd}>
          <FaPlus /> Add
        </Button>
        <Table className="table table-borderlesstable-hover" style={{textAlign:"center"}}>
          <thead style={{backgroundColor:"#A9A9A9", color:"#FFFFFF"}}>
            <tr>
